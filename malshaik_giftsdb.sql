...
(1, 'طارق', 'جابر', 'زواج', '2019-08-22', 'نود ان نبارك لزميلنا طارق بمناسبة عقد زفافه الميمون. نتمنى له كل التوفيق وبالرفاه والبنين. لمن يرغب بالمشاركة في اهداءه', 'images/wedding01.jpg', 0, '1234567890', 'email@gmail.com', 'Amman Shmesani');
-- --------------------------------------------------------
